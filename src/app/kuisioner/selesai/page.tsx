...
export default function KuisionerSelesai() {
  ...
  const userData = {
    ...
    interests: [
      ...
      {
        icon: "📈",
        text: "Menggunakan angka untuk membuat keputusan yang lebih baik",
      },
    ],
    recommendedJobs: [
      "Data Analyst",
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="flex flex-col w-full">
          <div className="mb-8">
            ...
            <p className="text-lg">
              Kami telah menganalisis jawabanmu, dan inilah gambaran minat serta
              kekuatan kamu berdasarkan hasil kuisioner. Yuk, lihat potensi dan
              peluang yang bisa kamu eksplorasi!
            </p>
          </div>
